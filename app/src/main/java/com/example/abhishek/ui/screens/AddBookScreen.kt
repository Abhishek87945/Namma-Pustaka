package com.example.abhishek.ui.screens
...
import com.example.abhishek.viewmodel.LibraryViewModel
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                shape = RoundedCornerShape(12.dp),
                trailingIcon = {
                    IconButton(onClick = { /* In a real app, open camera to scan for code */ }) {
                        Icon(Icons.Default.Search, contentDescription = "Scan Code")
                    }
                }
            )
